...
//   input.frameIndex =
//       env->GetLongField(jinput, env->GetFieldID(inputClass, "frameIndex",
//       "J"));
...
//   input.timestamp =
//       env->GetLongField(jinput, env->GetFieldID(inputClass, "timestamp",
//       "J"));
// }
...
//     env->SetObjectField(bbox, env->GetFieldID(bboxClass, "rect", "[I"),
//     jrect);
...
//   env->SetObjectField(joutput, env->GetFieldID(outputClass, "frameData",
//   "[B"),
//                       jframeData);
