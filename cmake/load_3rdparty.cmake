...
MACRO(LOAD_CRYPTOPP)
    SET(CRYPTOPP_HOME ${3RDPARTY_DIR}/cryptopp)
    IF (TARGET_OS STREQUAL "Android")
        SET(CMAKE_FIND_ROOT_PATH ${CMAKE_FIND_ROOT_PATH} ${CRYPTOPP_HOME}/share/cmake)
    ELSE()
        LIST(APPEND CMAKE_PREFIX_PATH ${CRYPTOPP_HOME}/share/cmake)
    ENDIF()
    ...
    ENDIF()
    LINK_DIRECTORIES(${CRYPTOPP_HOME}/lib)
ENDMACRO()
